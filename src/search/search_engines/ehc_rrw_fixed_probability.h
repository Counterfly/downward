#ifndef ENFORCED_HILL_CLIMBING_SEARCH_RRW_FIXED_PROB_H
#define ENFORCED_HILL_CLIMBING_SEARCH_RRW_FIXED_PROB_H
...
*/
class EnforcedHillClimbingSearchRRWFixedProbability : public SearchEngine {
...
public:
    explicit EnforcedHillClimbingSearchRRWFixedProbability(const options::Options &opts);
    virtual ~EnforcedHillClimbingSearchRRWFixedProbability() override;
